				...
				<div className={"flex flex-col md:flex-row items-center gap-12 lg:gap-20 xl:gap-40"}>
					...
					<div className={"flex items-center flex-col gap-0 md:gap-4"}>
						<div className={"flex text-white gap-0 lg:gap-4 text-xl font-medium "}>
							<div className={"flex flex-col items-center w-[100px] md:w-[125px] text-base md:text-xl"}>
						...
						<div className={"flex flex-col text-white gap-0 md:gap-2"}>
							<h1 className={"font-medium text-center text-base md:text-xl font-semibold"}>Inductive Priors</h1>
							<div className={"flex gap-2"}>
								<div className={"flex flex-col gap-0 md:gap-2"}>
									<h1 className={"font-serif text-center text-2xl md:text-4xl"}>Scientific Foundation</h1>
									<h1 className={"font-serif text-center text-2xl md:text-4xl"}>Models.</h1>
								</div>
							</div>
						</div>
