	...
	return (
		<div className={"bg-white py-10 flex flex-col gap-8 items-center"}>
			<div className={"flex flex-col w-3/4 gap-8 md:gap-0 md:flex-row"}>
				<div className={"flex flex-col w-full md:w-2/4 md:items-start md:justify-center"}>
				...
				<div className={"w-full md:w-2/4"}>
					<div className={"flex flex-col gap-4"}>
						<div className={"text-xl flex flex-col gap-4"}>
							<h1 className={"text-justify"}>Deep Forest Sciences has built an AI assistant Prithvi to accelerate scientific discoveries. Prithvi is powered by DeepChem infrastructure on the inside.</h1>
							<h1 className={"text-justify"}>Prithvi technologies have been deployed on multiple drug discovery, energy and molecular design projects.</h1>
						</div>
